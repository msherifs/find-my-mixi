...
const EnterPasswordScreen = ({ onNext }: { onNext: () => void }) => {
	...
	return (
		<div className="flex flex-col items-center gap-5">
			<h2 className="font-epilogue font-bold text-[96.96px] leading-[1] tracking-[-0.02em] text-center w-[680px]">
				{t("resetPassword.set_new_password")}
			</h2>
			<p className="font-normal text-[20.68px] leading-[31px] tracking-normal text-center w-[453px]">
...
const LoginScreen = () => {
	...
	return (
		<div className="flex flex-col items-center gap-5">
			...
			<h2 className="font-epilogue font-bold text-[96.96px] leading-[1] tracking-[-0.02em] text-center">
