				...
				>
					...
					<PopoverTrigger asChild>
						<Button
							...
							className={cn(
								"!h-12 w-full py-[10px] px-[14px] rounded-[10px] border border-[#E6E6E6] bg-white min-h-10 h-auto items-center justify-between hover:bg-inherit [&_svg]:pointer-events-auto",
						...
						>
							{selectedValues.length > 0 ? (
											...
											.map((value) => {
												...
												return (
													<Badge
														key={value}
														className={cn(
															"!bg-gray-200 !border-gray-300 !items-center gap-2 flex-shrink-0 whitespace-nowrap",
													...
													>
														...
														>
															<XCircle className={cn("text-black")} size={14} />
														</div>
													</Badge>
												);
											})
								...
								<div className="flex items-center justify-between w-full mx-auto">
									...
									<ChevronDown className="h-4 cursor-pointer text-gray-400 font-normal" />
								</div>
							)}
						</Button>
					</PopoverTrigger>
