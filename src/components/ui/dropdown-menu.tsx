...
function DropdownMenuTrigger({
	...
	return (
		<DropdownMenuPrimitive.Trigger
			...
			className="focus:outline-none focus:ring-0 focus-visible:ring-0 hover:outline-none hover:ring-0 hover-visible:ring-0"
			{...props}
		/>
	);
}
	...
	return (
		<DropdownMenuPrimitive.Item
			...
			className={cn(
				...
				"focus:outline-none focus:ring-0 focus-visible:ring-0 focus-visible:outline-none hover:bg-gray-100 hover:outline-none hover:ring-0 hover-visible:ring-0 cursor-pointer",
				className,
			)}
			{...props}
		/>
