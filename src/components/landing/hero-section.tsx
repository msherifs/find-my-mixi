...
const HeroSection = () => {
	...
	return (
		<section className="bg-[#FEDAFFB2] rounded-[40px] px-[72px] pt-15">
			...
			<div className="flex items-center">
				<p className="font-epilogue font-bold text-[50.68px] tracking-[-0.02em]">
					{t("heroSection.we_will_help_bring_them_home")}
				</p>
				<img
					src={HeartIcon}
					alt=""
			...
			<p className="font-normal text-[20.68px] leading-[31px] tracking-normal w-[511px]">
				{t("heroSection.we_quickly_reunite_text")}
			</p>
			<div className="flex items-center gap-4 mt-7">
				<Button size={"lg"}>{t("heroSection.lost_a_cat")}</Button>
				<Button
					variant={"secondary"}
					size={"lg"}
					className="shadow-none border-none"
				>
					{t("heroSection.found_a_cat")}
				</Button>
			</div>
			<div className="h-[450px] relative">
				<div className="absolute left-0 bottom-[40px] flex flex-col items-center">
					{/* <img src={UFO} alt="" className="relative top-[-120px] left-13" />
					<img src={UFOLight} alt="" className="relative top-[-110px] left-0" />
					<div className="backdrop-blur-[28px] bg-[#DD198E38] relative top-[-100px] left-0 h-2" /> */}
					<img src={UFO} alt="" className="relative left-5 mb-[10px]" />
					<img src={UFOLight} alt="" />
					<div className="backdrop-blur-[28px] bg-gradient-to-b from-[#DD198E38] to-transparent h-[35px] w-[100px] blur-[10px] relative" />
